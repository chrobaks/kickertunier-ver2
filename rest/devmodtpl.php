...
<body>
<p><a href="request.php?devmd=1&tbl=users&act=get">get users</a></p>
<p><a href="request.php?devmd=1&tbl=teams&act=get">get teams</a></p>
<p><a href="request.php?devmd=1&tbl=games&act=get">get games</a></p>
...
<div>
    ...
    <table>
        <tr>
        <?php print("<td><strong>".implode("</strong></td><td><strong>",array_keys($data["users"][0]))."</strong></td>");?>
        <td colspan="2"></td>
        </tr>
        ...
        <tr>
            ...
            <input type="hidden" name="devmd" value="1" />
            <input type="text" name="id" value="<?php print($v["id"]);?>" /></td>
...
<div>
    ...
    <input type="hidden" name="act" value="add" />
    <input type="hidden" name="devmd" value="1" />
    <input type="text" name="player_1" />&nbsp;<span>player 1</span><br />
    <input type="text" name="player_2" />&nbsp;<span>player 2</span><br />
    ...
    <table>
        <tr>
        <?php print("<td><strong>".implode("</strong></td><td><strong>",array_keys($data["teams"][0]))."</strong></td>");?>
        <td colspan="2"></td>
        </tr>
        <?php foreach($data["teams"] as $k=>$v): ?>
        <tr>
            <form action="request.php" method="get" name="formTeams<?php print($k);?>">
            <td><input type="hidden" name="tbl" value="teams" />
            <input type="hidden" name="act" value="" />
            <input type="hidden" name="devmd" value="1" />
            <input type="text" name="id" value="<?php print($v["id"]);?>" /></td>
...
<div>
    ...
    <input type="hidden" name="act" value="add" />
    <input type="hidden" name="devmd" value="1" />
    <input type="text" name="team_1" />&nbsp;<span>team 1</span><br />
    <input type="text" name="team_2" />&nbsp;<span>team 2</span><br />
    ...
    <table>
        <tr>
        <?php print("<td><strong>".implode("</strong></td><td><strong>",array_keys($data["games"][0]))."</strong></td>");?>
        <td colspan="2"></td>
        </tr>
